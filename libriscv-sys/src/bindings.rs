...
#[doc = " Fast-fork API: create lightweight Copy-on-Write VM forks"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of RISCVPageAttributes"][::std::mem::size_of::<RISCVPageAttributes>() - 28usize];
    ["Alignment of RISCVPageAttributes"][::std::mem::align_of::<RISCVPageAttributes>() - 4usize];
    ["Offset of field: RISCVPageAttributes::read"]
        [::std::mem::offset_of!(RISCVPageAttributes, read) - 0usize];
    ["Offset of field: RISCVPageAttributes::write"]
        [::std::mem::offset_of!(RISCVPageAttributes, write) - 4usize];
    ["Offset of field: RISCVPageAttributes::exec"]
        [::std::mem::offset_of!(RISCVPageAttributes, exec) - 8usize];
    ["Offset of field: RISCVPageAttributes::is_cow"]
        [::std::mem::offset_of!(RISCVPageAttributes, is_cow) - 12usize];
    ["Offset of field: RISCVPageAttributes::non_owning"]
        [::std::mem::offset_of!(RISCVPageAttributes, non_owning) - 16usize];
    ["Offset of field: RISCVPageAttributes::dont_fork"]
        [::std::mem::offset_of!(RISCVPageAttributes, dont_fork) - 20usize];
    ["Offset of field: RISCVPageAttributes::user_defined"]
        [::std::mem::offset_of!(RISCVPageAttributes, user_defined) - 24usize];
};
unsafe extern "C" {
...
#[doc = " Arena (native heap) management"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Alignment of RISCVReallocResult"][::std::mem::align_of::<RISCVReallocResult>() - 8usize];
    ["Offset of field: RISCVReallocResult::ptr"]
        [::std::mem::offset_of!(RISCVReallocResult, ptr) - 0usize];
    ["Offset of field: RISCVReallocResult::old_size"]
        [::std::mem::offset_of!(RISCVReallocResult, old_size) - 8usize];
};
